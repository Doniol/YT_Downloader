...
convert = str(input("Convert the videos to .mp3 files? y/n "))
...
# Convert the .mp4 files to .mp3, if selected
if convert == "y":
    for filename in os.listdir(SAVE_DOWNLOAD):
        videoclip = VideoFileClip(os.path.join(SAVE_DOWNLOAD, filename))
        audioclip = videoclip.audio
        audioclip.write_audiofile(os.path.join(SAVE_CONVERT, 
            filename[0 : filename.find(".mp4")] + ".mp3"))